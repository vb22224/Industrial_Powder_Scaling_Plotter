    ...
    if show:
        if plot_option != "Box":
            ...
            if simultaneous:
                ...
                if legend_option:
                    plt.legend(frameon=True, bbox_to_anchor=(1, 0.5))  # Option: loc="lower left" or loc="upper right", bbox_to_anchor=(1, 0.9) (shifts it down a little)
...
if __name__ == "__main__":
    ...
    remove_files = ['PP_02.txt', 'Flour_37.txt', 'CB_01.txt', 'CB_02.txt', 'CB_03.txt', 'Thiovit_51.txt']
    # remove_files += ['PP_18.txt']
    lol_labels = ["Polypropylene", "Zerostat", "Rested"]
    spec_cat = ['PP', 'Flour', 'Thiovit'] # specify categories to include if input type is categorised (file names before the underscore), leave empty to include all
    ...
    legend_option = False # If true plots a legend
